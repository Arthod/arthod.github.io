...
Paper is published in the IHTP special issue of *Operations Research, Data Analytics and Logistics* (ORDAL) dedicated to the problem and the competition. The paper is available [here](https://doi.org/10.1016/j.ordal.2026.200513).
